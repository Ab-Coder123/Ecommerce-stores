...
const Main = () => {
  ...
  const menCategoryAPI = "products?populate=*&filters[category][$eq]=male";
  const womenCategoryAPI = "products?populate=*&filters[category][$eq]=female";
              ...
              >
                ...
                <CardContent>
                  ...
                  <Typography variant="body2" color="text.secondary">
                    ...
                    {item.attributes.Description} with
                    over 6,000 species, ranging across all continents except
                    Antarctica
